...
public class CompletionServiceExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<LongRunningTask.TaskResponse> result = doParallelWork(tasks);
        System.out.println("Parallel Work output = " + result);
    }

    private static List<LongRunningTask.TaskResponse> doParallelWork(Collection<LongRunningTask> tasks) throws Exception {

        try (var service = Executors.newVirtualThreadPerTaskExecutor()) {
            
            CompletionService<LongRunningTask.TaskResponse> ecs
                 = new ExecutorCompletionService<LongRunningTask.TaskResponse>(service);
                          
            List<Future<LongRunningTask.TaskResponse>> taskFutures
            ...
            List<LongRunningTask.TaskResponse> result
