...
public class STaskScopeOnFailureExecutor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, LongRunningTask.TaskResponse> result 
        ...
        LongRunningTask.TaskResponse extResponse = result.get("extTask");
     ...
     */
    private static Map<String, LongRunningTask.TaskResponse> execute(Collection<LongRunningTask> tasks) 
        ...
        try(var scope = new StructuredTaskScope.ShutdownOnFailure()) {
            ...
            Map<String, LongRunningTask.TaskResponse> output 
                = subTasks.stream()
                    .filter(sub -> sub.state() == State.SUCCESS)
                    .map(Subtask::get)
                    .collect(Collectors.toMap(LongRunningTask.TaskResponse::name, r -> r));
