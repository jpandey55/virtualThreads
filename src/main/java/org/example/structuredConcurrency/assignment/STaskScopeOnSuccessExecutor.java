...
public class STaskScopeOnSuccessExecutor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LongRunningTask.TaskResponse result = execute(List.of(wthr1Task, wthr2Task));
     ...
     */
    private static LongRunningTask.TaskResponse execute(Collection<LongRunningTask> tasks)
        ...
        try(var scope = new StructuredTaskScope.ShutdownOnSuccess<LongRunningTask.TaskResponse>()) {
            ...
            LongRunningTask.TaskResponse output = scope.result();
